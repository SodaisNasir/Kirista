...
const Country = ({navigation, route}) => {
  ...
  const {setPhoneNumber, setFlagImage, type, newType, setCountry} =
    route.params;
    ...
    <>
      ...
      <View
        ...
        <View style={styles.backBox}>
          <Header
            text={applanguage.SelectCountry}
            DontGoBack={true}
                ...
                <View
                  style={{
                    ...
                    height:
                      w >= 768 && h >= 1024
                        ? verticalScale(25)
                        : verticalScale(30), // for ios 30 for android its 40, change to 40 for android upload
                  }}>
                  <Text
                    style={[
                      styles.title,
